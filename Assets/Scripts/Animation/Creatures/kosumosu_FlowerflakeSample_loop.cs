...
public class kosumosu_FlowerflakeSample_loop : MonoBehaviour
{
    [Header("出現位置の設定")]
    ...
    [SerializeField] private float _swayAmountMin = 1f; // 左右に揺れる最小距離
    [SerializeField] private float _swayAmountMax = 5f; // 左右に揺れる最大距離
