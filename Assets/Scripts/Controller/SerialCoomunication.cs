...
public class SerialCommunication : MonoBehaviour
{
    ...
    private void InitializeSerialPort()
    {
        try
        {
            ...
            serialPort.Open();
            Debug.Log($"�V���A���|�[�g���J���܂���: {PortName}");
        }
        catch (Exception ex)
        {
            Debug.LogError($"�V���A���|�[�g�ڑ��G���[: {ex.Message}");
        }
    }
    ...
    private void ReceiveSerialData()
    {
        ...
        {
            Debug.LogWarning("�f�[�^��M�^�C���A�E�g");
        }
        catch (Exception ex)
        {
            Debug.LogError($"��M�G���[: {ex.Message}");
        }
    }
